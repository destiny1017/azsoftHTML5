	...
	<div class="container-fluid" style="border: #757575 solid 2px;  margin: 0px 15px 0px 15px; padding: 5px 0px 5px 0px;">
		<div class="row-fluid">
			<div class="row">
				...
				<div class="col-xs-12 col-sm-1">
						<sbux-select id="cboDept" name="cboDept" uitype="single" jsondata-ref = "cboDept" jsondata-text="cm_deptname" jsondata-value="cm_deptcd"  style="width:100%;"></sbux-select>				
				</div>
				<div class="col-xs-12 col-sm-1">
				...
				<div class="col-xs-12 col-sm-2">
					...
					<sbux-radio id="rdoEndDate" name="rdoDate" uitype="normal" text="완료일기준" value="1"></sbux-radio>
				</div>
				<div class="col-xs-12 col-sm-1">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-1">
					<sbux-label id="lbBlank" name="lbBlank" uitype="normal" text="신청종류"></sbux-label>
				</div>
				<div class="col-xs-12 col-sm-1">
				...
				<div class="col-xs-12 col-sm-1">
					<sbux-label id="lbSta" name="lbSta" uitype="normal" text="진행상태"></sbux-label>
				</div>
				<div class="col-xs-12 col-sm-1">
